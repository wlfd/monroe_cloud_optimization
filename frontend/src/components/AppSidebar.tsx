...
import { LayoutDashboard, AlertTriangle, Lightbulb, Users, Settings, Database } from "lucide-react";
...
const adminNavItems = [{ title: "Ingestion", url: "/ingestion", icon: Database }];
                    ...
                    <SidebarMenuButton asChild>
                      ...
                      >
                        ...
                        {item.title === "Anomalies" && anomalyCount > 0 && (
                          <span
                            className={`ml-auto flex h-5 min-w-5 items-center justify-center rounded-full px-1 text-[10px] font-semibold text-white ${anomalyBadgeColor}`}
                          >
