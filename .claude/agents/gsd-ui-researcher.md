...
Use template from `/Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
