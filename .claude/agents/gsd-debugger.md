...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/wlfd/Developer/monroe_cloud_optimization/.claude
                  → checks /Users/wlfd/Developer/monroe_cloud_optimization/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done
                  → writes to /Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/hooks/
...
@/Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
