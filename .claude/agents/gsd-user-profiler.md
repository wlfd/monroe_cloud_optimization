...
<reference>
@/Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/references/user-profiling.md` to load:
