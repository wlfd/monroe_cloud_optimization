...
- Usage: Reference from command with `@/Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/wlfd/Developer/monroe_cloud_optimization/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/wlfd/Developer/monroe_cloud_optimization/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
