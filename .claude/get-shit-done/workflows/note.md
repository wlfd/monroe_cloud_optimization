...
- **Global scope**: `/Users/wlfd/Developer/monroe_cloud_optimization/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/wlfd/Developer/monroe_cloud_optimization/.claude/notes/`)
...
2. Glob `/Users/wlfd/Developer/monroe_cloud_optimization/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/wlfd/Developer/monroe_cloud_optimization/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/wlfd/Developer/monroe_cloud_optimization/.claude/notes/` — works in any directory
