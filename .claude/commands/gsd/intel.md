...
Intel system is disabled. To activate:
  ...
  node /Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/wlfd/Developer/monroe_cloud_optimization/.claude/get-shit-done/bin/gsd-tools.cjs
